from nanorodbuilder.particles import System, NanoParticle
# Custom packages
from nanorodbuilder.utils import geometry_tools, script_writing_object
...
def parameters():
    ...
    batch_filename = '../data/cluster_input.txt'
